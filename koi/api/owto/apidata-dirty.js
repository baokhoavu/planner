	    ...
	    owto192dayDaily: String,
	        ...
	        var owTo192day = locals2.getEventTotal.toronto.to19.twoDayWlk;
		        ...
		        var numberOwTo19v2 = Number(removeDollarOwTo19v2.replace(/[^0-9\.-]+/g,""));                                            
			        ...
			        var owto19RfiSub = locals2.getEventTotal.toronto.to19.rfi - data.owTo19RFI;
			        var owto19CrewsDailySub = locals2.getEventTotal.toronto.to19.crews - data.owTo19Crews;
